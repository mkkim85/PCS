...
double REPORT_RESP_T_TOTAL;
long REPORT_RESP_T_COUNT;
...
void sim_report(void)
{
	...
	fprintf(SETUP_REPORT_PATH, "clock,kW,total_kW,kW_npg,total_kW_npg,node,rack,total_resp_t,resp_t_count,avg_resp_t\n");
	...
	while (!CSIM_END)
	{
		...
		if (t > 0 && (t % hold_t) == 0)
		{
			...
			fprintf(SETUP_REPORT_PATH, "%ld,%lf,%lf,%lf,%lf,%ld,%ld,%lf,%ld,%lf\n",
